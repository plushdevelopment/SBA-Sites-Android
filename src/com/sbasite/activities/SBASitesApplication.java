...
import static com.sbasite.activities.SitesSqliteOpenHelper.*;
import android.util.Log;

public class SBASitesApplication extends Application {
	...
	public void onCreate() {
		...
		final XMLHandler myExampleHandler = new XMLHandler();
        myExampleHandler.delegate = this;
